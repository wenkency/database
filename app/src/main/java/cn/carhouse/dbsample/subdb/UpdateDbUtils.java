...
import cn.carhouse.db.update.CreateDb;
import cn.carhouse.db.update.CreateVersion;
import cn.carhouse.db.update.UpdateDb;
import cn.carhouse.db.update.UpdateDbXml;
import cn.carhouse.db.update.UpdateStep;
...
public class UpdateDbUtils {
    ...
    private void doUpdate(Context context, String oldVersion, String newVersion) {
        QuickDao<User> quickDao = QuickDaoFactory.getInstance().getQuickDao(User.class);
        QuerySupport<User> query = quickDao.query();
        query.limit("0 , 1");
